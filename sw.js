...
//  Cache: network-first for sheets/github, cache-first for app shell
// ═══════════════════════════════════════════════════════════════
const CACHE = 'bhok-lagyo-v3';
...
self.addEventListener('fetch', function(e) {
  ...
  // Always network-only for sheet calls, github API, fonts, analytics
